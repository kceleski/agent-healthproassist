          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="animate-fade-in">
              <div className="inline-block bg-healthcare-100 text-healthcare-700 px-3 py-1 rounded-full text-sm font-medium mb-6">
                Senior Care Placement & Care Management Platform
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
                Streamline Senior Living Referrals & Care Coordination
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                HealthProAssist empowers placement specialists and care managers with comprehensive tools for senior living referrals, 
                skilled nursing placements, and care transitions management.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  size="lg" 
                  variant="outline" 
                  className="text-md group bg-white hover:bg-healthcare-50"
                >
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Trusted by placement agencies, geriatric care managers, and healthcare discharge planners
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 rounded-xl text-center">
              ...
              <p className="text-muted-foreground">Licensed Care Communities</p>
            </div>
            <div className="glass-card p-8 rounded-xl text-center">
              <div className="text-4xl font-bold text-healthcare-600 mb-2">2,500+</div>
              <p className="text-muted-foreground">Successful Care Transitions</p>
            </div>
            <div className="glass-card p-8 rounded-xl text-center">
